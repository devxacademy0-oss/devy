...
📚 خدماتنا:
1. الدبلومات التكنولوجية: برمجة الويب (Front-End & Back-End / Impact Maker لمدة 8 شهور)، الذكاء الاصطناعي وتعلم الآلة، تحليل البيانات، تصميم UI/UX، الأمن السيبراني، وتطوير الموبايل. ودبلومة الجونيورز (10-15 سنة).
